...
echo -e ""
 echo -e  "${GREEN}  ╠═════════════════════════════════════════════════╣"
 echo -e  "${GREEN}  ║                     ${cyan} [ MENU 1 ]                  ${GREEN}║"
 echo -e  "${GREEN}  ╠═════════════════════════════════════════════════╣"
 ...
 echo -e  "${GREEN}  ╠═════════════════════════════════════════════════╣"
 echo -e  "${GREEN}  ║                    ${cyan}[ MENU 2 ]                  ${GREEN} ║"
 echo -e  "${GREEN}  ╠═════════════════════════════════════════════════╣"
 ...
 echo -e  " ${GREEN} ║\e[0m22. Menu $gl "
 echo -e  " ${GREEN} ║\e[0m23. Exit  $gl "
 echo -e  " ${GREEN} ╠═════════════════════════════════════════════════╣"
 echo -e  " ${GREEN} ║${cyan}  SCRIPT ARYA BLITAR UDANAWU                     ${GREEN}║"
 echo -e  " ${GREEN} ╚═════════════════════════════════════════════════╝\e[0m"
echo -e  ""
read -p " Select From Options [1-23 or x] : " menu
echo -e   ""
case $menu in
1)
clear
