...
echo -e "${GREEN}══════════════════════════════════════════════════════════${NC}"
 ...
 echo -e  "  ╠═════════════════════════════════════════════════╣" | lolcat
 echo -e  "  ║                 [ MENU MASSE ]                  ║" |lolcat
 echo -e  "  ╠═════════════════════════════════════════════════╣" | lolcat
 echo -e  " $rd ║\e[0m01. CREAT SSH & OpenVPN  $bl    "
 echo -e  " $rd ║\e[0m02. CREAT L2TP   $bl   "
 echo -e  " $rd ║\e[0m03. CREAT PPTP $gl   "
 echo -e  " $rd ║\e[0m04. CREAT WIREGUARD     $mg    "
 echo -e  " $rd ║\e[0m05. CREAT XRAY VMESS $mg   "
 echo -e  " $rd ║\e[0m06. CREAT XRAY VLESS   $bl   "
 echo -e  " $rd ║\e[0m07. CREAT TROJAN GFW  $bl   "
 echo -e  " $rd ║\e[0m08. CREAT TROJAN GO  $bl    "
 echo -e  " $rd ║\e[0m09. CEK RUNNING  $gl    "
 echo -e  "  ╠═════════════════════════════════════════════════╣" | lolcat
 echo -e  "  ║                 [ MENU 2 MASSEE ]               ║" |lolcat
 echo -e  "  ╠═════════════════════════════════════════════════╣" | lolcat
 echo -e  " $rd ║\e[0m10. Add Or Change Subdomain Host For VPS $bl    "
 echo -e  " $rd ║\e[0m11. Change Port Of Some Service  $bl   "
 echo -e  " $rd ║\e[0m12. Auto Backup Data VPS$gl   "
 echo -e  " $rd ║\e[0m13. Backup Data VPS $gl  "
 echo -e  " $rd ║\e[0m14. Restore Data VPS $gl  "
 echo -e  " $rd ║\e[0m15. Webmin Menu $gl  "
 echo -e  " $rd ║\e[0m16. Limit Bandwith Speed Server  $mg  "
 echo -e  " $rd ║\e[0m17. Check Usage of VPS Ram $mg   "
 echo -e  " $rd ║\e[0m18. Reboot VPS $bl   "
 echo -e  " $rd ║\e[0m19. Speedtest VPS  $bl   "
 echo -e  " $rd ║\e[0m20. Info System All Port $bl    "
 echo -e  " $rd ║\e[0m21. Info Auto Script $gl   "
 echo -e  " $rd ║\e[0m22. Exit  $gl "
 echo -e  "  \e[1;32m╠═════════════════════════════════════════════════╣" | lolcat
 echo -e  "  ║  SCRIPT ARYA BLITAR                             ║" | lolcat
 echo -e  "  \e[1;32m╚═════════════════════════════════════════════════╝" | lolcat
echo -e  ""
