...
xrayvless1="vless://${uuid}@${domain}:$tls?path=/NbcGroup&security=tls&encryption=none&type=ws#${user}"
xrayvless2="vless://${uuid}@${domain}:$nontls?path=/NbcGroup&encryption=none&type=ws#${user}"
systemctl restart xray.service
service cron restart
clear
echo -e "${CYAN}\033[0m${NC}"
echo -e "          XRAYS/VLESS         \E[0m"
echo -e ""
echo -e " Remarks     : ${user}"
echo -e " IP/Host     : ${MYIP}"
