...
echo -e ""
echo -e "========================================\033[0m${NC}"
echo -e "          Informasi SSH & OpenVPN          \E[0m"
echo -e "========================================\033[0m${NC}"
echo -e " IP/Host       : $IP"
...
echo -e "========================================\033[0m${NC}"
echo -e "            Payload Websocket Tls            \E[0m"
echo -e "========================================\033[0m${NC}"
echo -e "GET wss://bug.com [protocol][crlf]Host: ${domain}[crlf]Upgrade: websocket[crlf][crlf]"
echo -e "========================================\033[0m${NC}"
echo -e "           Payload Websocket No Tls            \E[0m"
echo -e "========================================\033[0m${NC}"
echo -e "GET / HTTP/1.1[crlf]Host: ${domain}[crlf]Upgrade: websocket[crlf][crlf]"
echo -e "========================================\033[0m${NC}"
echo -e "           Created       : $hariini           \E[0m"
echo -e "           Expired       : $expi            \E[0m"
echo -e "========================================\033[0m${NC}"
echo -e "${GREEN}Script By Arya Blitar\033[0m${NC}"
